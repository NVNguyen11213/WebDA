...
@Configuration
public class MvcConfigurer implements WebMvcConfigurer, Jw27Constants  { //interface
	@Bean
	public ViewResolver viewResolver() {
		// Xu ly va tra ve doi tuong view thong qua ten
		InternalResourceViewResolver bean = new InternalResourceViewResolver();
		bean.setViewClass(JstlView.class);
		bean.setPrefix("/WEB-INF/views/"); //Thư mục chứa view
		bean.setSuffix(".jsp"); // đuôi file
		return bean;
	}
