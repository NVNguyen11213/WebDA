		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h1 mb-3" style="font-weight: 700;">Add News</h1>

					<div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <sf:form class="form" action="${classpath }/admin/news/add-save" method="post" modelAttribute="news" enctype="multipart/form-data">
	                        		 <div class="form-body">
	                        			<div class="row">
